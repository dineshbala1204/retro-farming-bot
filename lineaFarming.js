// lineaFarming.js — Free Retro Farming Only
...
async function main() {
  console.log("🔁 Starting Linea Retro Farming (Free Only)...");
  ...
  try {
    ...
    if (estimatedGas.toString() === "0") {
      ...
      await sentTx.wait();
      console.log("🎉 Interaction done on Linea (simulated). TX Hash:", sentTx.hash);
    } else {
  ...
  console.log("✅ Finished Linea Free Farming");
}
