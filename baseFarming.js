// baseFarming.js — Free Retro Farming Only
...
async function main() {
  console.log("🔁 Starting Base Retro Farming (Free Only)...");
  ...
  try {
    ...
    if (estimatedGas.toString() === "0") {
      ...
      await sentTx.wait();
      console.log("🎉 Interaction done on Base (simulated). TX Hash:", sentTx.hash);
    } else {
  ...
  console.log("✅ Finished Base Free Farming");
}
